      ...
      <table class="table table-bordered table-responsive table-striped" cellpadding="10" cellspacing="0">
        ...
        <?php foreach ($data['alat'] as $alat) : ?>
          <tr>
            ...
            <td><?= $alat['Merk']; ?></td>
            <td><?= $alat['Qty']; ?></td>
            <td><a href="<?= BASEURL; ?>/alat/hapus/<?= $alat['id']; ?>" class="badge text-bg-danger float-end ms-1" onclick="return confirm('yakin?');">hapus</a>
              ...
              <a href="<?= BASEURL; ?>/alat/detail/<?= $alat['id']; ?>" class="badge text-bg-primary float-end ms-1">detail</a>
              <a href="<?= BASEURL; ?>/booking/book/<?= $alat['id']; ?>" class="badge text-bg-primary float-end ms-1">book</a>
            </td>
          </tr>
          <?php $i++; ?>
        <?php endforeach; ?>
